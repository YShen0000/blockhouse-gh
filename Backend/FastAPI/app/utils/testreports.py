...
from reportlab.platypus import (
    ...
    Image, Flowable, PageBreak, KeepTogether
)
...
# Example usage for another image
logo_path = os.path.join(IMAGES_DIR, 'hoodwinked-logo-pdf.png')

# Register fonts
pdfmetrics.registerFont(TTFont('CraftworkGrotesk-Bold', os.path.join(FONTS_DIR, 'CraftworkGrotesk-Bold.ttf')))
pdfmetrics.registerFont(TTFont('CraftworkGrotesk-Regular', os.path.join(FONTS_DIR, 'CraftworkGrotesk-Regular.ttf')))
pdfmetrics.registerFont(TTFont('CraftworkGrotesk-SemiBold', os.path.join(FONTS_DIR, 'CraftworkGrotesk-SemiBold.ttf')))
pdfmetrics.registerFont(TTFont('CraftworkGrotesk-Medium', os.path.join(FONTS_DIR, 'CraftworkGrotesk-Medium.ttf')))
...
def create_report_content(report_calculation, styles, doc):
    ...
    data = [
        ...
        [Paragraph(f'Your <img src="{logo_path}" width="277" height="53"></img>', title_style)],
    ...
    # add image here
    img_path = os.path.join(IMAGES_DIR, 'pdf-first-image.png') # Replace with actual path to your image
