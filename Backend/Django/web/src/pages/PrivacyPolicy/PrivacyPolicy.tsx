...
const PrivacyPolicy: React.FC = () => {
    return (
        <div className={css(styles.container)}>
            <h1 className={css(styles.title)}>Privacy Policy of Blockhouse</h1>
            <p>
                Blockhouse operates the www.blockhouse.app website, which
                provides the SERVICE.
                <br />
                <br />
                This page is used to inform website visitors regarding our
                policies with the collection, use, and disclosure of Personal
                Information if anyone decided to use our Service, the Blockhouse
                website.
                <br />
                <br />
                ...
                www.blockhouse.app, unless otherwise defined in this Privacy
                Policy.
            </p>
            ...
            <h1 className={css(styles.title)}>Log Data</h1>
            <p>
            ...
            <h1 className={css(styles.title)}>Cookies</h1>
            <p>
            ...
            <h1 className={css(styles.title)}>Service Providers</h1>
            ...
            <h1 className={css(styles.title)}>Security</h1>
            ...
            <h1 className={css(styles.title)}>Links to Other Sites</h1>
            ...
            <h1 className={css(styles.title)}>Children’s Privacy</h1>
            ...
            <h1 className={css(styles.title)}>Contact Us</h1>
