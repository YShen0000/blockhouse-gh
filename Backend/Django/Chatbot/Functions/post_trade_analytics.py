...
def post_trade_analytics(file_id, start_date=None, end_date=None):
    ...
    ).values('cusip', 'trade_size', 'trade_price', 'trade_timestamp') # Add asset_class to this later
    ...
    # TODO: Group by asset class and calculate metrics when we have asset class
    # results_df = merged_df.groupby(['asset_class']).agg(
