...
from data_handler import process_data, fetch_data, DataHandler
...
def run_equities_sell_inference(ticker, day_of_backtest, timeframe=390, inventory=10000, data=None, trade_set_counter=1):
    ...
    # end_timestamp = day_of_backtest #datetime.strptime(day_of_backtest, '%Y-%m-%d')

    # start_timestamp = end_timestamp
    
    # print("start_timestamp: ", start_timestamp, day_of_backtest)
    # processed_data = data_handler.get_data(ticker=ticker, start_date=start_timestamp, end_date=end_timestamp)[0]
