...
from blockhouse_ml.utils.macro_model import PPO_MODEL_BEST_PARAMS, MetaLearner
from blockhouse_ml.utils.macro_model import CustomTransformerPolicy, MetaLearner, PPO_MODEL_BEST_PARAMS, PPO_MODEL_BEST_PARAMS_TAB, TabTransformerPolicy
from blockhouse_ml.utils.env import TradingEnvironment, CustomTradingEnvironment, TradingEnvironmentMacroV2
from blockhouse_ml.utils.data_handler import InferenceDataHandler
...
class MacroTraderModel:
    ...
    def _get_small(self, data, file_path, market_cap='large', get_tab_transformer = False, training_config=PPO_MODEL_BEST_PARAMS):
        ...
        env = TradingEnvironment(data, action_space, original_action_space, preferred_timeframe=preferred_timeframe,
    ...
    def infer_macro(self, timeframe, transaction_size, market_cap_int, input_data, data, meta = MetaLearner(), inference_data_handler = InferenceDataHandler()):
        ...
        with torch.no_grad():
            ...
            env = TradingEnvironmentMacroV2(data, action_space, preferred_timeframe=preferred_timeframe,
                                 initial_inventory=initial_inventory, scenario='large')
