...
class Model:
    ...
    def infer_model(self, side='buy', timeframe=45, inventory = 1000, ticker = 'MSFT', end_timestamp = datetime.now(pytz.UTC).strftime('%Y-%m-%d'), backtest=False):
...
if __name__ == '__main__':
    ...
    model = Model()
    print(model.infer_model(side='sell',inventory = 10, ticker='TSLA', backtest = False))