...
class PolygonClient:
    ...
    def get_ohlcv(self, ticker, start_date, end_date):
        ...
        # Filter for trading hours in EST (9:30 AM to 4:00 PM EST)
        df_poly_ohlcv_filtered = df_poly_ohlcv.between_time('09:30', '16:00')
        # df_poly_ohlcv_filtered.index = df_poly_ohlcv_filtered.index.tz_convert('UTC')

        # df_poly_ohlcv.index = df_poly_ohlcv.index.astimezone(pytz.UTC)
        print(df_poly_ohlcv_filtered[-10:])
