...
class DatabentoClient:
    ...
    def fetch_and_merge_data(self, ticker, start_date, end_date):
        ...
        # print("df_ohlcv",df_ohlcv.columns)
        # print("df_mbo",df_mbo.columns)
    ...
    def get_quote(self, ticker, start_date, end_date):
        ...
        print("Columns in processed df_mbo:", df_mbo.columns)
...
class PolygonClient:
    ...
    def get_ohlcv(self, ticker, start_date, end_date):
        ...
        # Print the keys in the data and the entire response to inspect the structure
        # print("Keys in data:", data.keys())
        # print("Full Data:", data)  # Print the full data to see if it contains 'results'

        if 'results' not in data:
            print("No 'results' key found in the data response.")
            return None

        df_poly_ohlcv = pd.DataFrame(data['results'])
        # print("Initial DataFrame:", df_poly_ohlcv.head())  # Print the first few rows of the DataFrame
        ...
        print("Renamed DataFrame:", df_poly_ohlcv.head())
        ...
        print("Filtered DataFrame:", df_poly_ohlcv_filtered.head())
