...
from utils.fetch_merge_data import PolygonClient
...
class Model:
    ...
    def infer_model(self, side='buy', timeframe=60, inventory = 1000, ticker = 'MSFT', end_timestamp = datetime.now(pytz.UTC).strftime('%Y-%m-%d'), backtest=False):
...
if __name__ == '__main__':
    ...
    model = Model()
    print(model.infer_model(side='buy',inventory = 150, ticker='TSLA', backtest = False))