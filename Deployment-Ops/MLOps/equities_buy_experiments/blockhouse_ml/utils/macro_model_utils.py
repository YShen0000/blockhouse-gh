...
from blockhouse_ml.utils.env import CustomTradingEnvironment, TradingEnvironmentMacroV2
...
class MacroTraderModel:
    ...
    def __init__(self, model_dir = 'TabModels'):
        """
    ...
    def get_model(self, data, market_cap, scenario, training_config = PPO_MODEL_BEST_PARAMS):
        ...
        model_save_path = "./TabModels/model_large_cap_large.h5"
