...
from blockhouse_mls.equities.sell.utils.macro_model import PPO_MODEL_BEST_PARAMS, MetaLearner
from blockhouse_mls.equities.sell.utils.macro_model import CustomTransformerPolicy, MetaLearner, PPO_MODEL_BEST_PARAMS, PPO_MODEL_BEST_PARAMS_TAB, TabTransformerPolicy
from blockhouse_mls.equities.sell.utils.env import TradingEnvironment, CustomTradingEnvironment
from blockhouse_mls.equities.sell.utils.data_handler import InferenceDataHandler
...
class MacroTraderModel:
    ...
    def get_model(self, data, market_cap, scenario, training_config = PPO_MODEL_BEST_PARAMS, transaction_size =10000):
        ...
        model_.policy.load_state_dict(torch.load(model_save_path, map_location=device))
