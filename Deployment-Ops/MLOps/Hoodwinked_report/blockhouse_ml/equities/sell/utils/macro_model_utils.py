...
class MacroTraderModel:
    ...
    def get_model(self, data, market_cap, scenario, training_config = PPO_MODEL_BEST_PARAMS):
        ...
        model_.policy.load_state_dict(torch.load(model_save_path, map_location=torch.device('cpu')))
    ...
    def _get_medium_cap_model(self, data, scenario, get_tab_transformer=True, training_config=PPO_MODEL_BEST_PARAMS):
        """
    ...
    def _get_small_cap_model(self, data, scenario, get_tab_transformer=True, training_config=PPO_MODEL_BEST_PARAMS):
        """
