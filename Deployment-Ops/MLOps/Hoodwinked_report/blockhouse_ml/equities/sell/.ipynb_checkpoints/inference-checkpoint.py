...
class EquitiesSellInference:
    ...
    def run_pipeline(self, ticker, start_timestamp = (datetime.today() - timedelta(days=2)).strftime('%Y-%m-%d'), end_timestamp=datetime.today().strftime('%Y-%m-%d'), timeframe=390, inventory=10000, trade_set_counter=1):
        """
