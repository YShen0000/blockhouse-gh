...
def create_report_content(report_calculation, styles, doc):
    ...
    # Introduction
    intro_text = f"Based on an analysis of your stock trades over the last {total_days//30} months, you could have saved {Average_Optimal_Strategy} in trading costs by using Hoodwinked Optimal Execution (HWOE) Strategy. Read our report and find out how ->"
